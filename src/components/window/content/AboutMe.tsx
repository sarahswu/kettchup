        ...
        <div className='about-me'>
            <div className='about-me-container'>
                <div className='about-me-header border'>
                    <img className='me-img' src='assets/imgs/pikachu.gif' alt='pixil-me.png'/>
                    <h1>About Me</h1>
                </div>
                ...
                <div className='border'>
                    ...
                    <ul>
                        <li>honkai star rail <img src='assets/imgs/star100.gif' /></li>
                        <ul>
                        ...
                        <ul>
                            <li className='nestedListItem'>i like growing giant crops <img src='assets/imgs/carrot2.gif' /></li>
                        </ul>
                        <li>apex</li>
                    </ul>
                </div>
                <div className='border'>
                    <h2 className='font-mindset'>
                        recent songs:<img src='assets/imgs/musicnotes.gif'/>
                    </h2>
                    <ul>
