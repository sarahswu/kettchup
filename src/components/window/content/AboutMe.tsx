        ...
        <div className='about-me'>
            <div className='about-me-container'>
                <div className='about-me-header border'>
                    <img className='me-img' src='public/pikachu.gif' alt='pixil-me.png'/>
                    <h1>About Me</h1>
                </div>
                ...
                <div className='border'>
                    ...
                    <ul>
                        <li>honkai star rail <img src='public/star100.gif' /></li>
                        <ul>
                        ...
                        <ul>
                            <li className='nestedListItem'>i like growing giant crops <img src='public/carrot2.gif' /></li>
                        </ul>
                        <li>apex</li>
                    </ul>
                </div>
                <div className='border'>
                    <h2 className='font-mindset'>
                        recent songs:<img src='public/musicnotes.gif'/>
                    </h2>
                    <ul>
