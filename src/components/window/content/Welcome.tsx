            ...
            <div className='welcome-container'>
                <div className='welcome-header'>
                    <div className='dog-div'>
                        <img className='dog' src='/kettchup/src/assets/imgs/dog-wagging-tail-white-dog.gif'/>
                    </div>
                ...
                <p>I hope your time spent here is fun! <img src='/kettchup/src/assets/imgs/bunny25.gif' /></p>
            </div>
        </div>
    );
}
