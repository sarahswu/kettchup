      ...
      <div className='desktop'>
        ...
        <div className='desktop-icons'>
          <div className='welcome-icon' onClick={() => openWindow('welcome')}>
            <Icon img='/kettchup/src/assets/icons/msie2-2.png' name='welcome' />
          </div>
        ...
        <div className='desktop-taskbar'>
          <button className={showStartMenu ? 'start-button start-button-active' : 'start-button'} onClick={() => setShowStartMenu(!showStartMenu)}><img src='/kettchup/src/assets/imgs/my-melody.webp'/>Start</button>
            ...
            {showStartMenu ? 
              <div className='startMenu'>
                <div className='startMenu-link' onClick={() => {openWindow('welcome'); setShowStartMenu(false)}}>
                    <img src='/kettchup/src/assets/icons/msie2-2.png'/>
                    <p>welcome</p>
                </div>
                <div className='startMenu-link' onClick={() => {openWindow('about_me'); setShowStartMenu(false)}}>
                    <img src='/kettchup/src/assets/icons/notepad_file-2.png' />
                    <p>about me</p>
                </div>
              </div> : null}
          </div>
