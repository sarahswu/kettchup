      ...
      <div className='desktop'>
        ...
        <div className='desktop-icons'>
          <div className='welcome-icon' onClick={() => openWindow('welcome')}>
            <Icon img='/assets/icons/msie2-2.png' name='welcome' />
          </div>
        ...
        <div className='desktop-taskbar'>
          <button className={showStartMenu ? 'start-button start-button-active' : 'start-button'} onClick={() => setShowStartMenu(!showStartMenu)}><img src='/assets/icons/my-melody.webp'/>Start</button>
