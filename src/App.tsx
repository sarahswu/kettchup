      ...
      <div className='desktop'>
        ...
        <div className='desktop-icons'>
          <div className='welcome-icon' onClick={() => openWindow('welcome')}>
            <Icon img='public/msie2-2.png' name='welcome' />
          </div>
          <div className='about-me-icon' onClick={() => openWindow('about_me')}>
            <Icon img='public/notepad_file-2.png' name='about_me' />
          </div>
        </div>
        ...
        <div className='desktop-taskbar'>
          <button className={showStartMenu ? 'start-button start-button-active' : 'start-button'} onClick={() => setShowStartMenu(!showStartMenu)}><img src='public/my-melody.webp'/>Start</button>
